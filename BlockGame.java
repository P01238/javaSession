...
public class BlockGame {
    static class MyFrame extends JFrame {
        ...
        // constant
        static int BALL_WIDTH = 20; // BALL
        static int BALL_HEIGHT = 20;

        static int BLOCK_ROWS = 5; // BLOCK
        static int BLOCK_COLUMNS = 10;
        static int BLOCK_WIDTH = 40;
        static int BLOCK_HEIGHT = 20;
        static int BLOCK_GAP = 3;

        static int BAR_WIDTH = 80;// BAR
        static int BAR_HEIGHT = 20;

        static int CANVAS_WIDTH = 400 + (BLOCK_GAP * BLOCK_COLUMNS) - BLOCK_GAP;
        static int CANVAS_HEIGHT = 600;// CANVAS
        ...
        void checkCollision() {
            ...
            } else if (ball.y >= CANVAS_HEIGHT - BALL_HEIGHT) {
